...
class DessertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dessert" do
    assert_difference("Dessert.count") do
      post desserts_url, params: { dessert: { description: @dessert.description, name: @dessert.name } }
    end
  ...
  test "should update dessert" do
    patch dessert_url(@dessert), params: { dessert: { description: @dessert.description, name: @dessert.name } }
